...
class TestDatabase:
    # Проверяем что БД наполняет список булок 3 элементами и список ингридиентов 6 элементами
    ...
    # Проверяем что в список булок добавляются булки с верными названиями и ценами
    @patch("praktikum.bun.Bun")
    ...
    # Проверяем что в список ингредиентов добавляются ингредиенты с верными типами и названиями и ценами
    @patch("praktikum.ingredient.Ingredient")
    ...
    # Проверяем что метод возвращает верное количество булок
    @patch("praktikum.bun.Bun")
    ...
    # Проверяем что метод возвращает верное количество ингредиентов
    @patch("praktikum.ingredient.Ingredient")
